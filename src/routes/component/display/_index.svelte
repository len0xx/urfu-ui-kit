<script lang="ts">
    ...
    import { Code, Heading, Tag, Button, Text, Preloader } from '$lib/components'
...
<svelte:head>
    <title>УрФУ UI Kit – Отображение данных</title>
</svelte:head>
...
<div class="content">
    <main>
        ...
        <Heading size={1}>Отображение данных <a href="#" class="page-link" title="Ссылка на текущую страницу">🔗</a></Heading>
