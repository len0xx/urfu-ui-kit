<script lang="ts">
    import { Code, Heading, Tag, Grid, Link, Partner, Text, ParameterType } from '$lib/components'
...
<div class="content">
    <main>
        ...
        <Heading size={1}>Partner <a href="#" class="page-link" title="Ссылка на текущую страницу">🔗</a></Heading>
